...
parser = argparse.ArgumentParser(description='PyTorch CIFAR100 Attack Evaluation')
...
parser.add_argument('--data-attak-path',
                    default='./data_attack/cifar100_X_adv.npy',
                    help='adversarial data for white-box attack evaluation')
parser.add_argument('--data-path',
                    default='./data_attack/cifar100_X.npy',
                    help='data for white-box attack evaluation')
parser.add_argument('--target-path',
                    default='./data_attack/cifar100_Y.npy',
