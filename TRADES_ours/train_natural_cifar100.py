...
parser = argparse.ArgumentParser(description='PyTorch CIFAR100 Natural Training')
...
parser.add_argument('--model-dir', default='./model-cifar100-natural',
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if epoch % args.save_freq == 0 or epoch == args.epochs:
            ...
            torch.save(model.state_dict(),
                       os.path.join(model_dir, 'model-cifar100-natural-epoch{}.pt'.format(epoch)))
            torch.save(optimizer.state_dict(),
                       os.path.join(model_dir, 'opt-cifar100-natural-checkpoint_epoch{}.tar'.format(epoch)))
